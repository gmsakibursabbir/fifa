          ...
          >
            {COMPS.map((comp) => (
              <button
                ...
                className={cn(
                  "flex items-center gap-3 w-full px-5 py-3.5 text-xs font-bold uppercase tracking-wider text-left transition-colors border-b border-white/[0.02]",
                  selected === comp.code
                    ? "bg-white text-black"
                  ...
                  <table className="w-full text-left text-xs border-collapse">
                    ...
                    <tbody className="divide-y divide-white/5 font-sans">
                      {groupTable.table.map((row) => {
                        ...
                        return (
                          <tr key={row.team.id} className="hover:bg-white/[0.01]">
